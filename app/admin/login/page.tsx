...
export default function AdminLoginPage() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-[#020817] text-white">
      <div className="relative min-h-screen bg-[radial-gradient(circle_at_top,rgba(59,130,246,0.22),transparent_35%),radial-gradient(circle_at_bottom,rgba(34,211,238,0.12),transparent_30%),linear-gradient(180deg,#020817_0%,#07152b_55%,#0a1f44_100%)] px-4 py-6">
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-[380px] items-center justify-center">
          <div className="w-full rounded-3xl border border-white/10 bg-white/5 p-5 shadow-2xl backdrop-blur-2xl">
            <div className="mb-6 flex flex-col items-center text-center">
              <div className="mb-3 flex h-12 w-12 items-center justify-center rounded-2xl border border-cyan-400/25 bg-white/5 shadow-[0_0_30px_rgba(34,211,238,0.10)]">
            ...
            <div className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.06)] backdrop-blur-xl">
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/70">
                Sign in to manage licenses, Expert Advisors, analytics, and users.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="mt-2 flex h-12 w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-cyan-400 via-blue-500 to-cyan-300 text-base font-bold text-slate-950 shadow-[0_0_30px_rgba(56,189,248,0.28)] transition-all duration-300 hover:scale-[1.015] hover:shadow-[0_0_45px_rgba(56,189,248,0.45)] active:scale-[0.985] disabled:cursor-not-allowed disabled:opacity-75"
                >
                  {loading ? (
                    "Signing in..."
                  ) : (
